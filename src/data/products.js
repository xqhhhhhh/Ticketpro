export const products = [
  ...
  {
    id: 'thaiticketmajor',
    name: 'ThaiTicketMajor 抢票捡漏插件',
    shortName: 'ThaiTicketMajor',
    ...
    highlights: [
      {
        ...
        description: '围绕 ThaiTicketMajor 的场次进入、票档选择和锁票流程进行针对性适配，减少高峰期反复操作带来的时间损耗。',
        image: null,
      },
      {
        title: '公售与持续捡漏兼顾',
        description: '既可用于开售阶段快速执行购票步骤，也能在首轮售罄后持续检查票池，捕捉未付款释放或退回的余票。',
        image: null,
      },
      {
        title: '目标区域灵活配置',
        description: '支持按照想要的区域和票档配置目标范围，将刷新与锁票动作集中在真正需要的位置，提升操作效率。',
        image: null,
      },
      {
        title: '锁票提醒与持续维护',
        description: '成功锁票后及时发出电脑声音和多端消息提醒，避免错过付款窗口，并提供安装指导与后续版本维护。',
        image: null,
      },
    ],
    testimonialVideo: '/videos/interpark/testimonial.mp4',
  ...
  {
    id: 'hkticketing',
    name: '快达 HKTicketing 抢票捡漏插件',
    shortName: '快达 HKTicketing',
    description: '适配香港快达票务购票流程，支持公售抢票、自动捡漏、目标票档配置和锁票通知。',
    longDescription: '专为香港快达票务 HKTicketing 打造的抢票捡漏插件，适用于演唱会、舞台剧及其他热门活动。插件可自动衔接票务页面中的关键购票步骤，支持公售阶段快速执行和售罄后的持续捡漏，并可按目标票档、区域和数量调整配置。锁到票后会及时触发电脑及多端消息提醒，减少手动刷新和长时间守候带来的压力。购买后提供一机一码授权、详细教程及后续维护支持。',
    pricing: [
      { label: '月付', duration: '1个月', price: 66 },
      { label: '年付', duration: '1年', price: 99 },
      { label: '买断', duration: '永久', price: 128 },
    ...
    highlights: [
      {
        title: '快达票务流程适配',
        description: '针对 HKTicketing 的页面结构和购票步骤进行适配，自动完成重复操作，让高峰期购票流程更加连贯。',
        image: null,
      },
      {
        title: '公售抢票与售后捡漏',
        description: '开售时快速执行关键步骤，售罄后继续自动刷新票池，及时捕捉订单释放和退票产生的新余票。',
        image: null,
      },
      {
        title: '票档区域精准配置',
        description: '可根据活动情况设置目标票档、区域和购票数量，避免在不需要的位置浪费操作时间。',
        image: null,
      },
      {
        title: '多端提醒避免漏付',
        description: '锁票成功后通过电脑提示音和手机消息同步提醒，帮助你在有限的付款时间内及时完成订单。',
        image: null,
      },
    ],
    testimonialVideo: '/videos/interpark/testimonial.mp4',
  ...
  {
    id: 'tixcraft',
    name: '拓元 TixCraft 抢票捡漏插件',
    shortName: '拓元 TixCraft',
    description: '面向台湾拓元售票热门活动，支持自动化购票流程、目标场次票档配置和持续余票监控。',
    longDescription: '专为台湾拓元售票 TixCraft 设计的自动抢票捡漏插件，覆盖热门演唱会、音乐节及其他高需求活动。插件可按照目标场次、日期、票档与数量执行自动化购票操作，并在票池售罄后持续监控释放余票。运行参数可按不同活动灵活调整，成功锁票后通过电脑声音和多端消息及时通知。采用一机一码授权方式，并提供安装教程、使用指导和后续版本维护。',
    pricing: [
      { label: '月付', duration: '1个月', price: 80 },
      { label: '年付', duration: '1年', price: 128 },
      { label: '买断', duration: '永久', price: 168 },
    ...
    highlights: [
      {
        title: '拓元购票流程自动化',
        description: '针对 TixCraft 的活动、场次与票档选择流程进行适配，自动完成重复步骤，减少开售时的手动操作。',
        image: null,
      },
      {
        title: '场次票档定向配置',
        description: '支持提前设置目标日期、场次、票档及数量，让插件围绕明确目标持续执行，避免误选。',
        image: null,
      },
      {
        title: '售罄后的持续监控',
        description: '首轮未锁到票时仍可持续刷新和检查票池，及时处理未付款订单释放出来的余票机会。',
        image: null,
      },
      {
        title: '锁票通知与使用支持',
        description: '成功锁票后立即触发电脑声音及多端消息通知，同时提供激活、安装和使用过程中的维护支持。',
        image: null,
      },
    ],
    testimonialVideo: '/videos/interpark/testimonial.mp4',
